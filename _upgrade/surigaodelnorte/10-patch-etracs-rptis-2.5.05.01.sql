...
alter table examiner_finding add inspectedby_name varchar(150);
alter table examiner_finding add inspectedby_title varchar(150);
...
alter table `rptpayment_share`  add iscommon int default 0;
